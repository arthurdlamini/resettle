...
const cancelTokenRef = useRef();
	...
	const getFields = async () => {
		try {
			...
			const { data } = await api(user).get('/fields', {
...
const relocatedTrue = fields.filter(item => item?.relocated === true);
const relocatedFalse = fields.filter(item => item?.relocated === false);
                        ...
                        <div>
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel1-header"
                            >
                              <Typography>Relocated Fields</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <DataGrid
                                  autoHeight
                          ...
                          {true > 0 && (
                            <Accordion className="mt-1">
                              <AccordionSummary
                                ...
                                id="panel1-header"
                              >
                                <Typography>Not Relocated Fields</Typography>
                              </AccordionSummary>
                              <AccordionDetails>
